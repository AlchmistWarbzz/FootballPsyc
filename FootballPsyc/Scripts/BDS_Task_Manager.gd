...
func write_sst_raw_log(datetime_dict):
	...
	var raw_log_file_path: String = LevelManager.group_name + "_" + LevelManager.subject_name + "_target_digit_" + practice_str + "{year}-{month}-{day}-{hour}-{minute}-{second}_raw.txt".format(datetime_dict) # TODO let user choose dir
...
func write_sst_summary_log(datetime_dict):
	...
	var summary_log_file_path: String = LevelManager.group_name + "_" + LevelManager.subject_name + "_target_digit_" + practice_str + "{year}-{month}-{day}-{hour}-{minute}-{second}_summary.txt".format(datetime_dict) # TODO let user choose dir
